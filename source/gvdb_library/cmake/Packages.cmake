  ...
  if (OPENVDB_FOUND)
	  ...
	  if ( USE_OPENVDB ) 
		...
		if (MSVC_VERSION EQUAL 1916)
		  ...
		  LIST(APPEND LIBRARIES_OPTIMIZED "${OPENVDB_LIB_DIR}/Half-2_3.lib" )	
		  LIST(APPEND LIBRARIES_OPTIMIZED "${OPENVDB_LIB_DIR}/zlib.lib" )	
		  LIST(APPEND LIBRARIES_OPTIMIZED "${OPENVDB_LIB_DIR}/tbb.lib" )
		  LIST(APPEND LIBRARIES_OPTIMIZED "${OPENVDB_LIB_DIR}/boost_system-${MSVCX}-mt.lib" )
		  LIST(APPEND LIBRARIES_OPTIMIZED "${OPENVDB_LIB_DIR}/boost_thread-${MSVCX}-mt.lib" )
...
macro(_add_package_CUDPP)
  ...
  if (CUDPP_FOUND)
	  ...
	  if ( USE_CUDPP ) 
		...
		LIST(APPEND PACKAGE_SOURCE_FILES ${CUDPP_HEADERS} )
  	  else()
